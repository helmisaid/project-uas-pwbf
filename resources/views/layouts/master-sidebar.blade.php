<aside id="sidebar" class="sidebar">
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
        ...
        <li class="nav-heading">okoko</li>
        <li class="nav-item @if ($sb_menu == 'mahasiswa') menu-open @endif">
            <a class="nav-link collapsed @if ($sb_menu == 'mahasiswa') active @endif" data-bs-target="#charts-nav"
        ...
        <li class="nav-item @if ($sb_menu == 'Master') menu-open @endif">
            <a class="nav-link collapsed @if ($sb_menu == 'Master') active @endif" data-bs-target="#master-nav"
                data-bs-toggle="collapse" href="#">
                <i class="bi bi-database"></i><span>Master</span><i class="bi bi-chevron-down ms-auto"></i>
            </a>
            <ul id="master-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
                <li>
                    <a href="{{ url('/satuan') }}" class="@if ($sb_submenu == 'satuan') active @endif">
        ...
        <li class="nav-item @if ($sb_menu == 'perkuliahan') menu-open @endif">
            <a class="nav-link collapsed @if ($sb_menu == 'perkuliahan') active @endif" data-bs-target="#tables-nav"
                data-bs-toggle="collapse" href="#">
